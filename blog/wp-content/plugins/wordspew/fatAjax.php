...
function checkName() {
	...
	if (currentName.value != jalCookie) {
		document.cookie = "jalUserName="+currentName.value+"; expires=Thu, 29 Jun 2006 19:16:29 UTC;"
	}
...
function checkUrl() {
	...
	if (currentName.value != jalCookie) {
		document.cookie = "jalUrl="+currentName.value+"; expires=Thu, 29 Jun 2006 19:16:29 UTC;"
		return;
	}
