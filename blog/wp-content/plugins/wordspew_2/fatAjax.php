...
function filter_smilies(s) {
	for (var i = 0; i < smilies.length; i++) {
		...
		var replace = '<img src="http://disturbed-reality.de/blog/wp-images/smilies/' + smilies[i][1] + '" class="wp-smiley" alt="' + smilies[i][0].replace(/\\/g, '') + '" />';
...
var GetChaturl = "/blog/wp-content/plugins/wordspew_2/wordspew.php?jalGetChat=yes";
var SendChaturl = "/blog/wp-content/plugins/wordspew_2/wordspew.php?jalSendChat=yes";
var httpReceiveChat;
var httpSendChat;
...
function insertNewContent(liName,liText,lastResponse, liUrl, liId) {
	...
	Fat.fade_element("comment-new"+liId, 30, 1000, "#666666", "#FFFFFF");
}
...
function checkName() {
	...
	if (currentName.value != jalCookie) {
		document.cookie = "jalUserName="+currentName.value+"; expires=Thu, 19 Apr 2007 08:31:43 UTC;"
	}
...
function checkUrl() {
	...
	if (currentName.value != jalCookie) {
		document.cookie = "jalUrl="+currentName.value+"; expires=Thu, 19 Apr 2007 08:31:43 UTC;"
		return;
	}
